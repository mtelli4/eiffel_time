...
const UES: UE[] = [
  ...
  },
  {
    ...
    modules: [
      ...
      { code: 'R5.A.09', name: 'Virtualisation avancée' },
      { code: 'R5.A.10', name: 'Nouveaux paradigmes de base de données' },
      { code: 'R5.A.11', name: "Méthodes d'optimisation pour l'aide à la décision" },
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
                      ...
                      >
                        <ChevronDown
                          className={cn(
                            ...
                            expandedUEs.includes(ue.code) && "transform rotate-180"
                          )}
                        />
                        {ue.code} (ECTS: {ue.ects})
                      </button>
                    </th>
                    {expandedUEs.includes(ue.code) && ue.modules.map(module => (
                      <th
                        key={module.code}
            ...
            <tbody>
              {STUDENTS.filter(student => student.group === selectedGroup).map((student) => (
